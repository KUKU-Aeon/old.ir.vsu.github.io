			...
			<div class="dj-items_order_by">
				<div class="dj-items_order_by_in">
					<div class="dj-items_order_by_label"><?php echo JText::_('COM_DJCLASSIFIEDS_SORT_BY')?></div>															
						...
						<a class="<?php echo $sort_class; ?>" href="<?php echo JRoute::_('index.php?option=com_djclassifieds&view=profile&uid='.$uid_slug.'&order=title&ord_t='.$ord_t.'&Itemid='.$Itemid);?>">
						...
						<a class="<?php echo $sort_class; ?>" href="<?php echo JRoute::_('index.php?option=com_djclassifieds&view=profile&uid='.$uid_slug.'&order=cat&ord_t='.$ord_t.'&Itemid='.$Itemid);?>">
						...
						<a class="<?php echo $sort_class; ?>" href="<?php echo JRoute::_('index.php?option=com_djclassifieds&view=profile&uid='.$uid_slug.'&order=loc&ord_t='.$ord_t.'&Itemid='.$Itemid);?>">
						...
						<a class="<?php echo $sort_class; ?>" href="<?php echo JRoute::_('index.php?option=com_djclassifieds&view=profile&uid='.$uid_slug.'&order=price&ord_t='.$ord_t.'&Itemid='.$Itemid);?>">
						...
						<a class="<?php echo $sort_class; ?>" href="<?php echo JRoute::_('index.php?option=com_djclassifieds&view=profile&uid='.$uid_slug.'&order=date_a&ord_t='.$ord_t.'&Itemid='.$Itemid);?>">
						...
						<a class="<?php echo $sort_class; ?>" href="<?php echo JRoute::_('index.php?option=com_djclassifieds&view=profile&uid='.$uid_slug.'&order=date_sort&ord_t='.$ord_t.'&Itemid='.$Itemid);?>">
						...
						<a class="<?php echo $sort_class; ?>" href="<?php echo JRoute::_('index.php?option=com_djclassifieds&view=profile&uid='.$uid_slug.'&order=display&ord_t='.$ord_t.'&Itemid='.$Itemid);?>">
