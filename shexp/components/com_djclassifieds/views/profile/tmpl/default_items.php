...
?>
	...
	<?php	
		...
		<div class="item_row item_header main_title">
			...
			<?php } ?>
				<a <?php echo $title_a_style;?> class="<?php echo $class; ?>" href="<?php echo JRoute::_('index.php?option=com_djclassifieds&view=profile&uid='.$uid_slug.'&order=title&ord_t='.$ord_t.'&Itemid='.$Itemid);?>">
			...
			if($par->get('column_category','1')){$columns_a++; ?>
				<div class="item_col <?php echo $class; ?>">
					<a class="<?php echo $class; ?>" href="<?php echo JRoute::_('index.php?option=com_djclassifieds&view=profile&uid='.$uid_slug.'&order=cat&ord_t='.$ord_t.'&Itemid='.$Itemid);?>">
			...
			<div class="item_col <?php echo $class; ?>">
				<a class="<?php echo $class; ?>" href="<?php echo JRoute::_('index.php?option=com_djclassifieds&view=profile&uid='.$uid_slug.'&order=loc&ord_t='.$ord_t.'&Itemid='.$Itemid);?>">
			...
			<div class="item_col <?php echo $class; ?>">
				<a class="<?php echo $class; ?>" href="<?php echo JRoute::_('index.php?option=com_djclassifieds&view=profile&uid='.$uid_slug.'&order=price&ord_t='.$ord_t.'&Itemid='.$Itemid);?>">
			...
			<div class="item_col <?php echo $class; ?>">
				<a class="<?php echo $class; ?>" href="<?php echo JRoute::_('index.php?option=com_djclassifieds&view=profile&uid='.$uid_slug.'&order=date_a&ord_t='.$ord_t.'&Itemid='.$Itemid);?>">
			...
			<div class="item_col <?php echo $class; ?>">
				<a class="<?php echo $class; ?>" href="<?php echo JRoute::_('index.php?option=com_djclassifieds&view=profile&uid='.$uid_slug.'&order=date_e&ord_t='.$ord_t.'&Itemid='.$Itemid);?>">
			...
			<div class="item_col <?php echo $class; ?>">
				<a class="<?php echo $class; ?>" href="<?php echo JRoute::_('index.php?option=com_djclassifieds&view=profile&uid='.$uid_slug.'&order=display&ord_t='.$ord_t.'&Itemid='.$Itemid);?>">
			...
			<div class="item_col <?php echo $class; ?>">
				<a class="<?php echo $class; ?>" href="<?php echo JRoute::_('index.php?option=com_djclassifieds&view=profile&uid='.$uid_slug.'&order=distance&ord_t='.$ord_t.'&Itemid='.$Itemid);?>">
