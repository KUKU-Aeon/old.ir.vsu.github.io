...
<div class="useritems_search">
	<form action="<?php echo JURI::base();?>index.php" method="post" name="djForm"  class="form" enctype="multipart/form-data" >															
									 ...
									 foreach($i->offers as $ioffer){										
										...
										echo '<div class="item_row row'.$row.'">';										
											echo '<div class="item_col first">';										
												...
												echo '<a class="profile_name" href="index.php?option=com_djclassifieds&view=profile&uid='.$uid_slug.DJClassifiedsSEO::getMainAdvertsItemid().'">'.$ioffer->username.'</a><br/>';
