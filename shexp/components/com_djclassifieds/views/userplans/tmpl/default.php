								 ...
								 <?php if(count($plan->items)){ ?>
									...
									<div class="djcf_prow_details_content">
										<?php foreach($plan->items as $item){ ?>
									 		<div class="djcf_prow_desc_row">
									 			<?php if($item->i_name){
									 				echo '<a href="'.DJClassifiedsSEO::getItemRoute($item->item_id.':'.$item->i_alias,$item->cat_id.':'.$item->c_alias).'">'.$item->i_name.' ('.JText::_('COM_DJCLASSIFIEDS_AD_ID').': '.$item->item_id.')'.'</a>';
												 }else{
