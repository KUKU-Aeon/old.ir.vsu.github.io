			...
			<td class="td_pdetails">
				<?php 
					...
					if(strstr($this->item->pay_type, 'mc')){
						...
						foreach($pay_elems as $pay_el){
							if(strstr($pay_el, 'mc')){
								...
								echo '<div class="pd_row"><span>'.JText::_('COM_DJCLASSIFIEDS_CATEGORY').' ('.$mcat->name.')'.'</span><span class="price">'.DJClassifiedsTheme::priceFormat($c_price,$par->get('unit_price',''));
					...
					if(strstr($this->item->pay_type, 'type,')){
						...
						echo '<div class="pd_row"><span>'.JText::_('COM_DJCLASSIFIEDS_TYPE').' "'.$this->item->t_name.'"</span><span class="price">'.DJClassifiedsTheme::priceFormat($t_price,$par->get('unit_price',''));
					...
					foreach($this->promotions as $prom){
						...
						foreach($pay_type_a as $pay_type_e){
							if(strstr( $pay_type_e, $prom->name)){
								...
								echo '</span>';
								echo '<span class="price">'.DJClassifiedsTheme::priceFormat($prom_price,$par->get('unit_price',''));
