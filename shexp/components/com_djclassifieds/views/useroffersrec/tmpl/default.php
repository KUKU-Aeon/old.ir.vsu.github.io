				...
				<div class="item_row row<?php echo $row;?>">
					...
					if($offer->i_name){
						echo '<div class="item_col icon first"   >';
							echo '<a href="'.DJClassifiedsSEO::getItemRoute($offer->item_id.':'.$offer->i_alias,$offer->cat_id.':'.$offer->c_alias).'">';
						...
						echo '<div class="item_col name">';					
							echo '<h3><a class="title" href="'.DJClassifiedsSEO::getItemRoute($offer->item_id.':'.$offer->i_alias,$offer->cat_id.':'.$offer->c_alias).'" >'.$offer->i_name.'</a></h3>';
						echo '</div>';
					}else{
						echo '<div class="item_col icon first"  >';
							echo '<img src="'.JURI::base().'/components/com_djclassifieds/assets/images/no-image.png" ';
