...
class DjclassifiedsModelUserOffersRec extends JModelLegacy{	
	...
	function getOffers(){
		...
		$db			= JFactory::getDBO();
			...
			$query = "SELECT o.*, i.name as i_name, i.alias as i_alias, i.cat_id, i.currency, c.alias as c_alias, ".$u_name.", u.email FROM #__djcf_offers o, #__users u, #__djcf_items i "
