...
class DjclassifiedsModelUserOffersSub extends JModelLegacy{	
	...
	function getOffers(){
		...
		$db			= JFactory::getDBO();
			...
			$query = "SELECT o.*, i.name as i_name, i.alias as i_alias, i.cat_id, i.c_alias, i.user_id as i_user_id, i.username, i.u_email as email, i.currency   FROM #__djcf_offers o "
						."LEFT JOIN (SELECT i.*, c.alias as c_alias, ".$u_name.", u.email as u_email FROM  #__djcf_categories c, #__djcf_items i
