...
<div id="mybootstrap"class="<?php if(droptablesBase::isJoomla30()) echo 'joomla30'; ?>">
    ...
    <div id="rightcol">
                ...
                <div id="freeze_options">
                        ...
                        <div class="control-group spreadsheet_sync" >
                            ...
                            <div class="controls">
                                ...
                                <a href="index.php?page=wptm-foldertree&TB_iframe=true&width=600&height=550"  class="thickbox button carrot-flat-button"><?php echo JText::_('COM_DROPTABLES_VIEW_DROPTABLES_PARAM_BROWSE'); ?></a>        
                            </div>
                        </div>
		...
		<div class="control-group">
				...
				<a href="javascript:void(0);" class="dz-btn nephritis-flat-button"><?php echo JText::_('COM_DROPTABLES_VIEW_DROPTABLES_IMPORT_BTN') ?></a>
			</form>
                    </div>
                    <div class="controls pull-right" style="margin-right:10px">
                    	<a href="javascript:void(0);" class="carrot-flat-button" id="export-excel" data-format-excel="<?php echo $params->get('export_excel_format', 'xlsx') ?>">
