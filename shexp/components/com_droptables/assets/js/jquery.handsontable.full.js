  ...
  $documentElement.on('mousedown.' + instance.guid, function (event) {
    ...
    if (that.settings.outsideClickDeselects) {
      instance.deselectCell();
        ...
        //little hack in order to work witht CKeditor modal windows
...
//JoomUnited: undo
Handsontable.hooks.register('afterChangeStyle');
Handsontable.hooks.register('undoChangeStyle');
...
var addMergeActionsToContextMenu = function (defaultOptions) {
  ...
  defaultOptions.items.mergeCells = {
    ...
    callback: function () {
      ...
      // Joomunited : added after merge cell hook call                       
...
WalkontableOverlay.prototype.onScroll = function () {
  ...
  if(typeof this.windowScrollPosition == 'undefined') { this.windowScrollPosition  = Handsontable.Dom.getScrollTop(this) } 
...
WalkontableTable.prototype.draw = function (selectionsOnly) {
  if (!selectionsOnly) {
   ...
   //joomunited: comment below line to fix vertical scroll issue
