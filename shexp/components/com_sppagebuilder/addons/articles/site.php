...
class SppagebuilderAddonArticles extends SppagebuilderAddons{
	...
	public function render(){
		...
		$show_intro = (isset($this->addon->settings->show_intro) && $this->addon->settings->show_intro) ? $this->addon->settings->show_intro : 1;
		$intro_limit = (isset($this->addon->settings->intro_limit) && $this->addon->settings->intro_limit) ? $this->addon->settings->intro_limit : 200;
		$hide_thumbnail = (isset($this->addon->settings->hide_thumbnail) && $this->addon->settings->hide_thumbnail) ? $this->addon->settings->hide_thumbnail : 0;
		$show_author = (isset($this->addon->settings->show_author) && $this->addon->settings->show_author) ? $this->addon->settings->show_author : 1;
		$show_category = (isset($this->addon->settings->show_category) && $this->addon->settings->show_category) ? $this->addon->settings->show_category : 1;
		$show_date = (isset($this->addon->settings->show_date) && $this->addon->settings->show_date) ? $this->addon->settings->show_date : 1;
		$show_readmore = (isset($this->addon->settings->show_readmore) && $this->addon->settings->show_readmore) ? $this->addon->settings->show_readmore : 1;
		...
		$link_articles = (isset($this->addon->settings->link_articles) && $this->addon->settings->link_articles) ? $this->addon->settings->link_articles : 0;
