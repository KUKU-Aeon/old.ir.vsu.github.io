...
JLoader::register('JArchiveGzip', JPATH_LIBRARIES.'/joomla/archive/gzip.php');

/**
 * Gzip format adapter for the JArchive class
 */
class PerfectdashboardArchiveGzip extends JArchiveGzip
{
	/**
	 * Gzip file flags.
	 *
	 ...
	 */
	private function raiseWarning($code, $msg = 'gz')
	{
