...
class DroptablesModelCategories extends CategoriesModelCategories
{   
    ...
    public function __construct($config = array()) {
        ...
        $app->setUserState('com_categories.categories.filter.extension', 'com_droptables');
        $app->setUserState('list.limit',100000);
    }
    ...
    public function populateState($ordering = null, $direction = null) {
        ...
        $this->setState('filter.extension', 'com_droptables');
        $this->state->set('list.limit', 100000);        
    }
    ...
    public function getListQuery() {
        ...
        if($catid!==null){
            $subQuery = "SELECT rgt,lft FROM #__categories WHERE id=".(int)$catid." AND extension='com_droptables'";
