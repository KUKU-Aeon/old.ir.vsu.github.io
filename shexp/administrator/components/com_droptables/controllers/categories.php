...
class DroptablesControllerCategories extends CategoriesControllerCategories
{
    ...
    * @since	1.6
    */
   function getModel($name = 'Category', $prefix = 'DroptablesModel', $config = array('ignore_request' => true))
   {
	...
	public function delete()
	{
		...
		if($cid){
			...
			$model = $this->getModel();
                        ...
                        $joomla31 = false;
                        if(version_compare(droptablesBase::getJoomlaVersion(), '3.1')){
                            $joomla31 = true;
                        }
