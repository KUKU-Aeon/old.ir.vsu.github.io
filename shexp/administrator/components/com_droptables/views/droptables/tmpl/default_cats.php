...
<div id="mycategories">
    ...
    <div id="newDbtable" class="">
        <a id="newDbtableBtn" class="btn btn-default" href="index.php?option=com_droptables&view=dbtable"><?php echo JText::_('COM_DROPTABLES_LAYOUT_DBTABLES_NEW_TABLE'); ?></a>
    </div>
    <?php endif; ?>
    <div class="nested dd">
                    ...
                    $content .= '<a href="" class="t">
                        ...
                        if(isset($this->tables[$this->categories[$index]->id])){
                            foreach ($this->tables[$this->categories[$index]->id] as $table) {
                                $content .= '<li class="droptablestable" data-id-table="'.$table->id.'" data-table-type="'.$tableType.'" >';
