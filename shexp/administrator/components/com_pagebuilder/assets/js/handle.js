...
(function ($) {
    ...
    $.HandleElement.editElement = function (shortcodeName, params, modalParams, isEdit) {
        ...
        $.post(
            JSNPbParams.rootUrl + 'administrator/index.php?option=com_pagebuilder&task=shortcode.savesession&tmpl=component&shortcode=' + shortcodeName + '&' + token + '=1',
            {
                params: params,
    ...
    $.HandleElement._showSettingModal = function (shortcodeName, params, isSubmodal, isEdit, modalParams, extraAction) {
        ...
        var frame_url = JSNPbParams.rootUrl + 'administrator/index.php?option=com_pagebuilder&task=shortcode.settings&shortcode=' + shortcodeName + '&' + token + '=1';
        ...
        var modal = new $.JSNModal({
            ...
            buttons: [{
                ...
                'click': function () {
                    ...
                    {
                    	if (!isSubmodal) {
                    		 var active_item = $("#form-container .active-shortcode");
    ...
    $.HandleElement.finalize = function (modal) {
        ...
        //$('.jsn-item').removeClass('active-shortcode');
        ...
        $.HandleElement.updateElement = function (shortcode, isEdit, current_container, parentContainer, elementAction) {
            ...
            if (isEdit) {
                ...
                if ((typeof(this.extraAction) != 'undefined' && this.extraAction == 'convert') || isSubmodal) {
                    ...
                    $.post(
                        JSNPbParams.rootUrl + 'administrator/index.php?option=com_pagebuilder&task=shortcode.generateHolder' + '&' + token + '=1',
                        {
    ...
    $.HandleElement.customCss = function () {
        ...
        setTimeout(function () {
            ...
            var frame_url = JSNPbParams.rootUrl + 'administrator/index.php?option=com_pagebuilder&view=builder&tmpl=component&pb_custom_css=1&id=' + content_id + '&' + token + '=1';
                ...
                modal = new $.JSNModal({
                    ...
                    buttons: [{
                        ...
                        'click': function () {
                            ...
                            //save data
                            $.post(
                                JSNPbParams.rootUrl + 'administrator/index.php?option=com_pagebuilder&task=builder.save_css_custom' + '&' + token + '=1',
                                {
