				...
				<div class="span12 form-horizontal">
					<fieldset class="adminform">
						<ul class="nav nav-tabs">
							...
							<?php
								$tab_titles = $dispatcher->trigger('onAdminProfileEditTabTitle', array ($this->jprofile,$this->profile));
								if(count($tab_titles)){
						...
						<div class="tab-content">
							...
							<?php
								$tab_contents = $dispatcher->trigger('onAdminProfileEditTabContent', array ($this->jprofile,$this->profile));
