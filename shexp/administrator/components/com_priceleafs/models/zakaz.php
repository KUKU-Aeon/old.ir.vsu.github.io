 ...
 * HelloWorld Model
 */
class PriceleafsModelZakaz extends JModelAdmin
{
/**
...
//Возвращает ссылку на объект таблицы, при его создании.	 
	public function getTable($type = 'Zakaz', $prefix = 'PriceleafsTable', $config = array())
	{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_priceleafs.zakaz', 'zakaz', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) 
		{
			return false;
		}
	...
	protected function loadFormData() 
	{
		...
		$data = JFactory::getApplication()->getUserState('com_priceleafs.edit.zakaz.data', array());
		if (empty($data)) 
		{
			$data = $this->getItem();
		}
