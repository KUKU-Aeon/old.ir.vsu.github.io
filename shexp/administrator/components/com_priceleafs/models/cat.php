 ...
 * HelloWorld Model
 */
class PriceleafsModelCat extends JModelAdmin
{
/**
...
//Возвращает ссылку на объект таблицы, при его создании.	 
	public function getTable($type = 'Cat', $prefix = 'PriceleafsTable', $config = array())
	{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_priceleafs.cat', 'cat', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) 
		{
			return false;
		}
	...
	protected function loadFormData() 
	{
		...
		$data = JFactory::getApplication()->getUserState('com_priceleaf.edit.cat.data', array());
		if (empty($data)) 
		{
			$data = $this->getItem();
		}
