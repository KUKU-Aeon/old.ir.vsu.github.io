 ...
 * HelloWorld Model
 */
class PriceleafsModelMenu extends JModelAdmin
{
/**
...
//Возвращает ссылку на объект таблицы, при его создании.	 
	public function getTable($type = 'Menu', $prefix = 'PriceleafsTable', $config = array())
	{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_priceleafs.menu', 'menu', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) 
		{
			return false;
		}
