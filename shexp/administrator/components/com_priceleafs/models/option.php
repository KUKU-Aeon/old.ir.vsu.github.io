 ...
 * HelloWorld Model
 */
class PriceleafsModelOption extends JModelAdmin
{
/**
...
//Возвращает ссылку на объект таблицы, при его создании.	 
	public function getTable($type = 'Option', $prefix = 'PriceleafsTable', $config = array())
	{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_priceleafs.option', 'option', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) 
		{
			return false;
		}
	...
	protected function loadFormData() 
	{
		...
		$data = JFactory::getApplication()->getUserState('com_priceleaf.edit.menu.data', array());
		if (empty($data)) 
		{
			$data = $this->getItem();
		}
