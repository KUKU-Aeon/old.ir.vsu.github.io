 ...
 * Класс вида
 */
class PriceleafsViewCat extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title($isNew ? JText::_('COM_PRICELEAF_CATIGORIES_NEW') : JText::_('COM_PRICELEAF_OPTION_EDIT'), 'priceleafs.png');
