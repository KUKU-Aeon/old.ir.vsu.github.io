 ...
 * Вид компонента
 */
class PriceleafsViewZakazs extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		PriceleafsHelper::addSubmenu('zakazs');
	...
	protected function addToolbar()
	{
		...
		if ($canDo->get('core.create')) {
			JToolbarHelper::addNew('zakaz.add');
		}
		if ($canDo->get('core.edit')) {
			JToolbarHelper::editList('zakaz.edit');
		}
		
			JToolbarHelper::publish('zakazs.publish', 'JTOOLBAR_PUBLISH', true);
			JToolbarHelper::unpublish('zakazs.unpublish', 'JTOOLBAR_UNPUBLISH', true);
		

			JToolbarHelper::deleteList('', 'zakazs.delete');



		JHtmlSidebar::setAction('index.php?option=com_priceleafs&view=zakazs');
