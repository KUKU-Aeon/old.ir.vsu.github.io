 ...
 * Класс вида
 */
class PriceleafsViewOption extends JViewLegacy
{
	protected $state;
	...
	public function display($tpl = null)
	{
		...
		PriceleafsHelper::addSubmenu('option');
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title($isNew ? JText::_('COM_PRICELEAF_OPTION_NEW') : JText::_('COM_PRICELEAF_OPTION_EDIT'), 'priceleafs.png');
		...
		echo JText::_('COM_PRICELEAF_OPTIONS_WARNING');
