 ...
 * Класс вида
 */
class PriceleafsViewPriceleaf extends JViewLegacy
{
...
JToolbarHelper::title($isNew ? JText::_('COM_PRICELEAF_RAZDEL_NEW') : JText::_('COM_PRICELEAF_RAZDEL_EDIT'), 'priceleafs.png');
		...
		if (!$checkedOut && ($canDo->get('core.edit')||(count($user->getAuthorisedCategories('com_priceleafs', 'core.create')))))
		{
			...
			JToolbarHelper::save2new('priceleaf.save2new');
		}
		
			if ($canDo->get('core.create')) {
				JToolbarHelper::save2copy('priceleaf.save2copy');
			}

		if (empty($this->item->id)) {
			JToolbarHelper::cancel('priceleaf.cancel');
		}
		else {
			JToolbarHelper::cancel('priceleaf.cancel', 'JTOOLBAR_CLOSE');
		}
