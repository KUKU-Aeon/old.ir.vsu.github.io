 ...
 * Класс контрорллера
 */
class PriceleafsControllerPriceleaf extends JControllerForm
{
...
//Метод переопределения, что бы проверить можно ли добавить новую запись.
	public function batch($model = null)
	{
		...
		$model = $this->getModel('Priceleaf', '', array());

		// Предустановленная переадресация
		$this->setRedirect(JRoute::_('index.php?option=com_priceleafs&view=priceleafs' . $this->getRedirectToListAppend(), false));
