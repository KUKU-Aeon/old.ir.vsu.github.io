 ...
 * Класс контроллера
 */
class PriceleafsControllerPriceleafs extends JControllerAdmin
{
	/**
	 * Прокси для getModel
	 */
	public function getModel($name = 'Priceleaf', $prefix = 'PriceleafsModel', $config = array('ignore_request' => true))
	{
