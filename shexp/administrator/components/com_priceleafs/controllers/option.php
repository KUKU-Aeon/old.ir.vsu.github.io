 ...
 * Класс контрорллера
 */
class PriceleafsControllerOption extends JControllerForm
{
...
//Метод переопределения, что бы проверить можно ли добавить новую запись.
	public function batch($model = null)
	{
		...
		$model = $this->getModel('Option', '', array());

		// Предустановленная переадресация
		$this->setRedirect(JRoute::_('index.php?option=com_priceleafs&view=option' . $this->getRedirectToListAppend(), false));
