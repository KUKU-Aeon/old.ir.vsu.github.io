 ...
 * Класс контрорллера
 */
class PriceleafsControllerZakaz extends JControllerForm
{
...
//Метод переопределения, что бы проверить можно ли добавить новую запись.
	public function batch($model = null)
	{
		...
		$model = $this->getModel('Zakaz', '', array());

		// Предустановленная переадресация
		$this->setRedirect(JRoute::_('index.php?option=com_priceleafs&view=zakazs' . $this->getRedirectToListAppend(), false));
