 ...
 * Класс контрорллера
 */
class PriceleafsControllerMenu extends JControllerForm
{
...
//Метод переопределения, что бы проверить можно ли добавить новую запись.
	public function batch($model = null)
	{
		...
		$model = $this->getModel('Menu', '', array());

		// Предустановленная переадресация
		$this->setRedirect(JRoute::_('index.php?option=com_priceleafs&view=menus' . $this->getRedirectToListAppend(), false));
