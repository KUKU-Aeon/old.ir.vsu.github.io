...
return [
    ...
    'filename' => '/var/www/ir.vsu.ru/shexp/templates/jf_sirena/jf/particles/jf_p_teams.yaml',
    'modified' => 1490205216,
    'data' => [
                                            ...
                                            'fields' => [
                                                'tab_sub_global' => [
                                                    ...
                                                    'fields' => [
                                                        ...
                                                        '.item_css' => [
                                                            'type' => 'input.text',
                                                            'label' => 'Column CSS Style',
                                                            'description' => 'Type css styles for column, for example - padding: 20px'
                                                        ],
                                                        '.grid' => [
                                                            'type' => 'select.select',
