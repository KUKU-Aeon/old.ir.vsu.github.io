...
?>
<div class="newsflash<?php echo $moduleclass_sfx; ?> jf_sp_newsflash sidebar">
		...
		?>
			...
			?>
				<div class="jf_sp_nf_cover">
					<img class="lazyload" data-src="<?php echo $images->image_intro; ?>" alt="<?php echo htmlspecialchars($item->title); ?>" />
				</div>
			<?php } ?>
