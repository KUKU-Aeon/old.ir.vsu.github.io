            ...
            twitter: {
                ...
                utility: {
                    ...
                    getDataPosts: function(element, i){
                        ...
                        tweet.link = 'https://twitter.com/' + tweet.page_name + '/status/' + tweet.id;
            ...
            instagram: {
                ...
                utility: {
                    ...
                    getDataPosts: function(element, i){
                        ...
                        var photo = {}, date,
                            months = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'Septemper', 'October', 'November', 'December'], info = container.find('.social-info .social-info-instagram');
        ...
        var Render = {
            ...
            twitter: function(tweet, i) {
                ...
                if(disable && Utility.checkState(disable, 'name')){
                    ...
                    page_name_markup = '<div class="social-page-name">' +
                                            '<a href="https://twitter.com/' + page_name + '">' +
                                                username +
                                            '</a>' +
                                        '</div>';
                }
                ...
                if(disable && Utility.checkState(disable, 'thumbnail')){
                    ...
                    thumbnail_markup = '<div class="social-thumbnail"><a href="https://twitter.com/'+ page_name + '"><img src="' + thumbnail + '" alt="' + page_name + '"></a></div>';
                }
