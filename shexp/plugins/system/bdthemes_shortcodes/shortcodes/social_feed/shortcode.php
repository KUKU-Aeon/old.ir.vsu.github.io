...
class Su_Shortcode_social_feed extends Su_Shortcodes {
    ...
    public static function social_feed($atts = null, $content = null) {
        ...
        $atts['instagram_client_id'] = ($atts['instagram_client_id']) ? $atts['instagram_client_id'] : $params->get('instagram_client_id');
        ...
        if ($atts['instagram_id'] and $atts['instagram_client_id']) {
            $ig_setting = array(
                'instagram' => array(
                    'account'   => $atts['instagram_id'],
                    'client_id' => $atts['instagram_client_id'],
                    'limit'     => $atts['limit'],
                    'disable'   => array("thumbnail", "date", "name")
                )
            );
