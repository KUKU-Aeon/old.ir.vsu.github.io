        ...
        return array(
            ...
            'atts'  => array(
                ...
                'position' => array(
                        'type'    => 'select',
                        'values'  => array(
                            'facebook'  => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_DEFAULT'),
                            'twitter'   => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_LEFT'),
                            'instagram' => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_RIGHT')
                        ),
                    'default' => 'default',
